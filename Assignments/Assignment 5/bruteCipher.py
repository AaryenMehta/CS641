...
input_file = open("Assignments/Assignment 5/input.txt", 'r')
output_file = open("Assignments/Assignment 5/output_clean.txt", 'r')
...
for index in range(6):
    ...
    inp = open("Assignments/Assignment 5/input.txt", 'r')
    out = open("Assignments/Assignment 5/output_clean.txt", 'r')
...
LINEAR_MATRIX = [[84, 125, 19, 104, 100, 19, 10, 66], 
                 [0, 70, 28, 20, 42, 51, 118, 8],
                 [0, 0, 43, 2, 13, 18, 9, 94],
                 [0, 0, 0, 12, 115, 32, 101, 23],
                 [0, 0, 0, 0, 112, 101, 23, 17],
                 [0, 0, 0, 0, 0, 11, 92, 72],
                 [0, 0, 0, 0, 0, 0, 27, 31],
                 [0, 0, 0, 0, 0, 0, 0, 38]]
